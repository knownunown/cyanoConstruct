...
class ComponentDB(db.Model):
        ...
        def getRightSpacer(self):
                return ("GG" if self.getType() == "RBS" else "") + self.getSpacerData().getSpacerRight() # what is this naming
        ...
        def getFullSpacerRight(self):
                return ("GG" if self.getType() == "RBS" else "") + self.getSpacerData().getFullSeqRight()
